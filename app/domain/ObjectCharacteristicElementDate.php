...
/**
 * Defines the app_domain_ObjectCharacteristicElementDate class. 
 ...
 * @package Alchemis
 */
class app_domain_ObjectCharacteristicElementDate extends app_domain_ObjectCharacteristicElement 
{
	/**
