DROP PROCEDURE IF EXISTS alchemis.sp_report_5_5_3;

delimiter |

create procedure alchemis.sp_report_5_5_3(var_in_date_start datetime, var_in_date_end datetime, var_in_client_id int(11))
...
--order by t.tc_parent, activity_percentage desc;
