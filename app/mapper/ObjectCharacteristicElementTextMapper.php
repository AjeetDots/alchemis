...
/**
 * Defines the app_mapper_ObjectCharacteristicElementTextMapper class. 
 ...
 * @package Alchemis
 */
class app_mapper_ObjectCharacteristicElementTextMapper extends app_mapper_ObjectCharacteristicElementMapper implements app_domain_ObjectCharacteristicElementTextFinder
{
	protected function init()
	{
		// Select single
		$query = 'SELECT * FROM tbl_object_characteristic_elements_text WHERE id = ?';
		$types = array('integer');
		$this->select_stmt = self::$DB->prepare($query, $types);
		
		// Select all records by object characteristic id
		$query = 'SELECT e.id FROM tbl_object_characteristic_elements_text AS e ' .
		...
		// Insert
		$query = 'INSERT INTO tbl_object_characteristic_elements_text ' .
		...
		// Update
		$query = 'UPDATE tbl_object_characteristic_elements_text ' .
		...
		// Delete
		$query = 'DELETE FROM tbl_object_characteristic_elements_text WHERE id = ?'; 
		$types = array('integer');
	...
	{
		$this->id = self::$DB->nextID('tbl_object_characteristic_elements_text');
		return $this->id;
	}
