...
/**
 * Defines the app_mapper_ObjectCharacteristicElementDateMapper class. 
 ...
 * @package Alchemis
 */
class app_mapper_ObjectCharacteristicElementDateMapper 
{
	protected function init()
	{
		// Select single
		$query = 'SELECT * FROM tbl_object_characteristic_elements_date WHERE id = ?';
		$types = array('integer');
		$this->select_stmt = self::$DB->prepare($query, $types);
		
		// Select all records by object characteristic id
		$query = 'SELECT e.id FROM tbl_object_characteristic_elements_date AS e ' .
		...
		$query = 'SELECT e.* FROM tbl_object_characteristic_elements_date AS e ' .
		...
		// Insert
		$query = 'INSERT INTO tbl_object_characteristic_elements_date ' .
		...
		// Update
		$query = 'UPDATE tbl_object_characteristic_elements_date ' .
		...
		// Delete
		$query = 'DELETE FROM tbl_object_characteristic_elements_date WHERE id = ?';
		$types = array('integer');
