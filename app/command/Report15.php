...
/**
 * Defines the app_command_Report15 class.
...
require_once('app/report/Report15.php');

/**
 * @package Alchemis
 */
class app_command_Report15 extends app_command_Command
{
...
//        $this->validateParameters($start, $end, $client_id);
        $pdf = new app_report_Report15($client_id);
        $pdf->Output(date('Y-m-d') . 'Client Exception Report.pdf', 'I');
    }
