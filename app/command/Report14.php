...
/**
 * Defines the app_command_Report14 class.
...
require_once('app/report/Report14.php');

/**
 * @package Alchemis
 */
class app_command_Report14 extends app_command_Command
{
    public function doExecute(app_controller_Request $request)
    {
        ...
        // Validate and set
        $pdf = new app_report_Report14($year, $nbm_exclusions, $user->client_id);
        $pdf->Output(date('Y-m-d') . 'NBM Bonus Detail report.pdf', 'I');
    }
