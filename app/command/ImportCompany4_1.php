 ...
 * @package Alchemis
 */
class app_command_ImportCompany4_1 extends app_command_ManipulationCommand
{
    protected $records;
    protected $success;
    protected $failure;
	...
	private function init(app_controller_Request $request)
	{
		...
		app_domain_ImportCompany::updateKnownSubCategory_1();
    ...
    {
        return app_domain_ImportCompany::doFindImportSubCategories_1NotInLookupData();
    }
    ...
    protected function processForm(app_controller_Request $request)
    {
      ...
      foreach ($properties as $key => $item)
      {
          ...
          if ($temp !== false)
          {
              ...
              {
                  app_domain_ImportCompany::updateUnknownSubCategory_1($unknown_sub_category, $sub_category_id);
              }
          }
      }
      ...
      echo '<p>Field sub_category_1 updated</p>';
      return true;
    }
}
?>
