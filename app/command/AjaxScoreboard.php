...
class app_command_AjaxScoreboard extends app_command_AjaxCommand
{
	...
	public function execute()
	{
		...
		$cmd_action = isset($this->request->cmd_action) ? $this->request->cmd_action : null;
		switch ($cmd_action)
		{
			case 'get_home_scoreboard':
				...
				$this->request->callback_count = $scoreboard->getCallBackCount();
				$this->request->priority_callback_count = $scoreboard->getPriorityCallBackCount();
