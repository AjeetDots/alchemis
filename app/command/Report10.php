...
/**
 * Defines the app_command_Report10 class.
...
require_once('app/report/Report10.php');

/**
 * @package Alchemis
 */
class app_command_Report10 extends app_command_Command
{
    public function doExecute(app_controller_Request $request)
    {
        ...
        $pdf = new app_report_Report10($start, $end);
        $pdf->Output(date('Y-m-d') . 'Industry Sector Analysis Report.pdf', 'I');
    }
