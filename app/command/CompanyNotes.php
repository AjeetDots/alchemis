...
/**
 * Defines the app_command_CompanyNotes class. 
...
class app_command_CompanyNotes extends app_command_Command
{
	...
	protected function processForm(app_controller_Request $request)
	{
	 ...
	 /** Initialises form data by assigning them to the request
	 * @param app_controller_Request $request 
	 */
	protected function init(app_controller_Request $request)
	{
		$notes = app_domain_CompanyNote::findByCompanyId($request->getProperty('company_id'));
