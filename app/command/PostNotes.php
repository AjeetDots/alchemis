...
/**
 * Defines the app_command_PostNotes class. 
...
class app_command_PostNotes extends app_command_Command
{
	...
	{
		$notes = app_domain_PostNote::findByPostId($request->getProperty('post_id'));
