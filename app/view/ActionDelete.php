...
/**
 * Defines the app_view_ActionDelete class. 
 ...
 * @package Alchemis
 */
class app_view_ActionDelete extends app_view_ManipulationView
{
	protected function doExecute()
	{
		// Init
		$this->smarty->assign('action', $this->request->getObject('action'));
