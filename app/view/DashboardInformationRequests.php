...
/**
 * Defines the app_view_DashboardInformationRequests class. 
 ...
 * @package Alchemis
 */
class app_view_DashboardInformationRequests extends app_view_View
{
...
//		$end_date   = substr($start_datetime, 0, 10);
		...
		$this->smarty->display('DashboardInformationRequests.tpl');
	}
