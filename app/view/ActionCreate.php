...
/**
 * Defines the app_view_ActionCreate class. 
 ...
 * @package Alchemis
 */
class app_view_ActionCreate extends app_view_ManipulationView
{
...
//		echo '</pre>';
		...
		$this->smarty->assign('nbm_id', $this->request->getProperty('nbm_id'));
		...
		$this->smarty->display('ActionCreate.tpl');
	}
}
