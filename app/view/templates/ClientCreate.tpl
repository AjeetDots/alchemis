{include file="header2.tpl" title="Create Client"}

{if $success}

	<p>Client details are being refreshed.</p>
	<script language="JavaScript" type="text/javascript">
iframeLocation(		parent, 'index.php?cmd=CampaignView&client_options={$id}');
	</script>
...
{else}
	...
	<form action="index.php?cmd=ClientCreate" method="post" name="adminForm" autocomplete="off">
		...
		<fieldset class="adminform">
			...
			<table>
				<tr>
					<td>Name *</td>
					<td>
						<input type="text" name="client_name" id="client_name" style="width:200px" value="" maxlength="100" />
					</td>
				</tr>
				<tr>
					<td>Telephone</td>
					<td>
						<input type="text" name="telephone" id="telephone" style="width:200px" value="" maxlength="50" />
					</td>
				</tr>
				<tr>
					<td>Fax</td>
					<td>
						<input type="text" name="fax" id="fax" style="width:200px" value="" maxlength="50" />
					</td>
				</tr>
				...
				<tr>
					<td>Website</td>
					<td>
						<input type="text" name="website" id="website" style="width:200px" value="" maxlength="100" />
					</td>
				</tr>
				<tr>
					<td style="vertical-align: top;">Financial year start date</th>
					<td style="width: 70%;">
						<input type="text" value="" id="financial_year_start_date" name="financial_year_start_date" />
				...
				<tr>
					<td>Address 1</td>
					<td><input type="text" name="address_1" id="address_1" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Address 2</td>
					<td><input type="text" name="address_2" id="address_2" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Address 3</td>
					<td><input type="text" name="address_3" id="address_3" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Town</td>
					<td><input type="text" name="town" id="town" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				<tr>
					<td>County</td>
					<td>
						<select name="county_id" id="county_id" style="width: 100%">
							{html_options options=$counties_options}
						</select>
					</td>
				</tr>
				<tr>
					<td>Postcode</td>
					<td><input type="text" name="postcode" id="postcode" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				<tr>
					<td>Country</td>
					<td>
						<select name="country_id" id="country_id" style="width: 100%">
							{html_options options=$countries_options}
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td>Name</td>
					<td><input type="text" name="primary_contact_name" id="primary_contact_name" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Job Title</td>
					<td><input type="text" name="primary_contact_job_title" id="primary_contact_job_title" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Telephone</td>
					<td><input type="text" name="primary_contact_telephone" id="primary_contact_telephone" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Email</td>
					<td><input type="text" name="primary_contact_email" id="primary_contact_email" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				<tr>
					<td colspan="2"><hr /></td>
				</tr>
				...
				<tr>
					<td>Name</td>
					<td><input type="text" name="secondary_contact_name" id="secondary_contact_name" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Job Title</td>
					<td><input type="text" name="secondary_contact_job_title" id="secondary_contact_job_title" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Telephone</td>
					<td><input type="text" name="secondary_contact_telephone" id="secondary_contact_telephone" style="width:200px" value="" maxlength="100" /></td>
				</tr>
				
				<tr>
					<td>Email</td>
					<td><input type="text" name="secondary_contact_email" id="secondary_contact_email" style="width:200px" value="" maxlength="100" /></td>
				</tr>
