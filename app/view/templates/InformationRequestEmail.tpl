...
<h2>Email Information Request Details</h2>
	
{if !$email_sent}

	{*<p><em>Required fields are marked with an asterisk (*).</em></p>*}
	
	<form action="index.php?cmd=InformationRequestEmail" method="post" name="adminForm" autocomplete="off">
		...
		<table class="adminlist">
			...
			<tr>
				...
				<td><input type="text" class="text" id="subject" name="subject" value="New information request from {$company->getName()}" maxlength="255" size="50" /></td>
			</tr>
			<tr>
