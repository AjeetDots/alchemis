...
<table class="adminform">
	<tr>
					...
					<td>
						...
						<table id="tbl_characteristic_list" class="adminlist">
							...
							<tr id="tr_{$characteristic->getId()}">
								...
								<td style="text-align: center; vertical-align: middle">{if $characteristic->hasAttributes()}<img src="{$APP_URL}app/view/images/icons/tick.png" alt="Yes" title="Yes" />{/if}</td>
								<td style="text-align: center; vertical-align: middle">{if $characteristic->hasOptions()}<img src="{$APP_URL}app/view/images/icons/tick.png" alt="Yes" title="Yes" />{/if}</td>
								<td style="text-align: center; vertical-align: middle">{if $characteristic->hasMultipleSelect()}<img src="{$APP_URL}app/view/images/icons/tick.png" alt="Yes" title="Yes" />{/if}</td>
		...
		<td width="50%" valign="top">
			<iframe id="iframe1" name="iframe1" src="" scrolling="yes" border="0" frameborder="no" style="height: 760px; width: 100%; overflow-x: hidden; overflow-y: y:auto"></iframe>
		</td>
	</tr>
</table>
