{include file="header2.tpl" title="Message Summary"}

<table id="table1" class="adminlist" cellspacing="1"{*class="sortable"*}{* border="0" cellpadding="0" cellspacing="1" width="100%"*}>
	<thead>
		<tr>
			<th style="width: 1%; text-align: center">#</th>
			<th style="width: 30%; text-align: left">From</th>
			<th style="width: 43%; text-align: left">Subject</th>
			<th style="width: 25%; text-align: left">Received</th>
			<th style="width: 1%">&nbsp;</th>
		</tr>
	</thead>
	<tfoot>
	...
	<tbody>
		{foreach name=loop1 from=$messages item=message}
		<tr>
		...
		{foreachelse}
		<tr>
			<td colspan="5" style="text-align: center">&mdash;</td>
		{/foreach}
	</tbody>
</table>
