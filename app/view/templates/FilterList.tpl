...
// Auto-load Campaign (2) and Global (3) filter rows on page load
// so users see them immediately without having to click the section headers
...
<table class="adminform">
	<tr>
		<td width="50%" valign="top">
			<table id="" class="adminlist" border="0" cellpadding="0" cellspacing="0">
				<tr class="hdr">
					<td style="vertical-align: middle">
						Filters for {$user.handle}&nbsp;&nbsp;|&nbsp;&nbsp;
						<a href="#" onclick="javascript:addFilter()"><img src="{$APP_URL}app/view/images/icons/table_add.png" alt="Add Filter" title="Add a new filter" /></a>
				...
				<tr valign="top">
					<td>
						<div id="content-pane" class="pane-sliders">
							...
							<!-- Personal filters start here -->
							<div class="panel">
								<h3 class="moofx-toggler title" id="filter_type_1_count"><span>Personal ({$filters_personal_count})</span></h3>
			...
			{*									<th style="width: 20%; text-align: center">Created On</th>*}
										...
										<tbody>
											...
											{foreach name=fil from=$filters_personal item=filter}
		...
		<td width="50%" valign="top">
			<iframe id="iframe1" name="iframe1" src="" scrolling="yes" border="0" frameborder="no" style="height: 720px; width: 100%; overflow-x: hidden; overflow-y: auto"></iframe>
		</td>
	</tr>
</table>
</form>
