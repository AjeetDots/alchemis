...
<form action="index.php?cmd=Categories&action=store" method="post" name="adminForm" autocomplete="off">
 ...
 <fieldset class="adminform">
   ...
   <table>
     <tr>
       <td style="width: 80px" {if isset($errors.value)} class="key_error" title="{$errors.value.0}"{else}class="key"{/if}>
          <label for="value">Value *</label>
       </td>
        <td><input type="text" name="value" id="value" style="width: 200px" value="{$input.value|default:''}" maxlength="255"  ac-value="id" ac-text="value" /></td>
     </tr> 
   </table>
 </fieldset>
