{include file="header2.tpl" title="Tags"}
...
function addTag(parent_object_id, category_id)
{
	...
	getAjaxData("AjaxTag", "", "insert{/literal}{$parent_object_type}{literal}Tag", ill_params, "Saving...")
}
...
function deleteTag(tag_id)
{
	...
	if (confirm("Confirm delete?"))
	{
		...
		ill_params.parent_object_id = parent_object_id;
		getAjaxData("AjaxTag", "", "delete{/literal}{$parent_object_type}{literal}Tag", ill_params, "Saving...")
	}
}
...
<table id="tbl_tags" class="adminlist" cellspacing="1"{*class="sortable"*}{* border="0" cellpadding="0" cellspacing="1" width="100%"*}>
	<thead>
		<tr>
			...
			<th colspan="2"style="width: 95%; text-align: left">
				...
				<a href="#" onclick="javascript:addTag({$parent_object_id}, {$category_id});">[Add]</a>
			</th>
		</tr>
	...
	<tbody>
		...
		<tr id="{$tag->getId()}">
			...
			<td>
				<a href="javascript:deleteTag({$tag->getId()});" title="Delete tag">
