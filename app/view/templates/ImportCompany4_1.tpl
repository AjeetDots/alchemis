...
{include file="header2.tpl" title="Import Company 4_1 "}
...
{/literal}
    ...
    <form action="index.php?cmd=ImportCompany4_1" method="post" name="adminForm" autocomplete="off">
		...
		<table id="tbl_county" class="sortable" style="width:100%;">
			...
			<tbody style="vertical-align:top">
				...
				<tr>
					<td>
                        {$line_item.sub_category_1}
                    </td>
					<td>
					    <select id="new_sub_category_{$line_item.sub_category_1}" name="new_sub_category_{$line_item.sub_category_1}">
		...
		{else}
		No unknown entries found for field sub_category_1
		{/if}  
		</form>
	</div>
</div>
