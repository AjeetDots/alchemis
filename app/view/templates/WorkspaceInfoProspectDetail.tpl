...
<div id="content-pane" class="pane-sliders" style="width: 100%">
	...
	<div class="panel">
		<h3 class="moofx-toggler title" id="cpanel-panel"><span>Information Requests</span></h3>
		<div class="moofx-slider content">
			<p>Summary - will use for projects</p>
			<p>Known agencies<br />
			<ul>
			<li>Black Cat</li>
			<li>Brown and Brown</li>
			</ul>
			</p>
		</div>
	</div>
	...
	<div class="panel">
		<h3 class="moofx-toggler title" id="cpanel-panel"><span>References</span></h3>
		<div class="moofx-slider content">
			<p>Summary - will use for projects</p>
			<p>Known agencies<br />
			<ul>
	...
	<div class="panel">
		<h3 class="moofx-toggler title" id="cpanel-panel"><span>Notes/Comments</span></h3>
		<div class="moofx-slider content">
			<p><b><em>19 October 2006 - David Newman</em></b><br />Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor 
