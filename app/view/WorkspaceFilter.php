 ...
 * @package Alchemis
 */
class app_view_WorkspaceFilter extends app_view_View
{
	protected function doExecute()
	{
		...
		else
		{
			...
			$initiativeId = $this->request->getObject('initiative_id');
			$initiative = app_model_Initiatives::with('campaign')->find($initiativeId);
			$this->smarty->assign('initiative_id', $initiativeId);
		...
		$this->smarty->display('WorkspaceFilter.tpl');
	}
}
