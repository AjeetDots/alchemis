 ...
 * @package Alchemis
 */
class app_view_ImportPost2 extends app_view_ManipulationView
{
	protected function doExecute()
	{
		...
		$this->smarty->assign('contact_processed_count', $this->request->getProperty('contact_processed_count'));
		
		$this->smarty->assign('company_added_count', $this->request->getProperty('company_added_count'));
		$this->smarty->assign('contact_added_count', $this->request->getProperty('contact_added_count'));
		
		$this->smarty->assign('company_existing_count', $this->request->getProperty('company_existing_count'));
		$this->smarty->assign('contact_existing_count', $this->request->getProperty('contact_existing_count'));
		
		$this->smarty->assign('company_duplicates_count', $this->request->getProperty('company_duplicates_count'));
		$this->smarty->assign('contact_duplicates_count', $this->request->getProperty('contact_duplicates_count'));
		
		$this->smarty->assign('company_failure_count', $this->request->getProperty('company_failure_count'));
		$this->smarty->assign('contact_failure_count', $this->request->getProperty('contact_failure_count'));
		
		$this->smarty->assign('log_file_path', $this->request->getProperty('log_file_path'));
		
    	$this->smarty->display('ImportPost2.tpl');
	}
}
