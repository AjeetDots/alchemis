...
/**
 * Defines the app_view_MessageDelete class. 
 ...
 * @package Alchemis
 */
class app_view_MessageDelete extends app_view_ManipulationView
{
	protected function doExecute()
	{
		// Init
		$this->smarty->assign('message_id', $this->request->getObject('message_id'));
		$this->smarty->assign('message',    $this->request->getObject('message'));
