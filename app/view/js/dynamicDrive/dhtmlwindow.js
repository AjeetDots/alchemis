...
// window.onunload is deprecated and blocked by modern browsers'
// permissions/document policy, which produces console warnings.
// Cleanup here is only to avoid old IE memory leaks, so it is safe
// to disable in modern environments.
