...
/**
 * Defines the app_view_WorkspaceProjectRefTags class. 
 ...
 * @package Alchemis
 */
class app_view_WorkspaceProjectRefTags extends app_view_View
{
	protected function doExecute()
	{
		...
		$this->smarty->assign('initiative_tags', $this->request->getObject('initiative_tags'));
		
		$this->smarty->display('WorkspaceProjectRefTags.tpl');
	}
}
