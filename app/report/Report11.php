...
/**
 * Defines the app_report_Report11 class.
 ...
 * @package Alchemis
 */
class app_report_Report11 extends FPDF
{
...
//        $this->params['client_id']                     = $client_id;
        ...
        $this->globalDisciplineEffectivenessSection();
        $this->nbmDisciplineEffectivenessSection();
	...
	public function Header()
	{
		...
		$this->Cell(50, 5, 'Report ID 11', 0, 0, 'L', 0);
		$this->SetFont('Arial', 'B', 10);
		$this->Cell(90, 5, 'Discipline Analysis Report', 0, 0, 'C', 0);
		$this->SetFont('Arial', '', 8);
    ...
    public function globalDisciplineEffectivenessSection()
    {
        $this->AddPage();

        $this->SetFont('Arial', 'B', 10);

        $rows = app_domain_ReportReader::getReport11GlobalDisciplineAnalysis($this->params['start'], $this->params['end']);
    ...
    public function nbmDisciplineEffectivenessSection()
    {
        ...
        $rows = app_domain_ReportReader::getReport11NbmDisciplineAnalysis($this->params['start'], $this->params['end']);
