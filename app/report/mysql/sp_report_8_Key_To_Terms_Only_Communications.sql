DROP PROCEDURE IF EXISTS `sp_report_8_Key_To_Terms_Only_Communications`;

delimiter |

create procedure sp_report_8_Key_To_Terms_Only_Communications (var_in_date_start datetime, var_in_date_end datetime, var_in_client_id int(11))
