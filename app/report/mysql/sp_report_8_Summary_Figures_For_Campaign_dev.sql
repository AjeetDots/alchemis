DROP PROCEDURE IF EXISTS `sp_report_8_Summary_Figures_For_Campaign_dev`;

delimiter |

create procedure sp_report_8_Summary_Figures_For_Campaign_dev (var_in_date_start datetime, var_in_date_end datetime, var_in_client_id int(11))
