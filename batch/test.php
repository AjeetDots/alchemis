...
$sql = 'drop table if exists campaigns_with_targets';
// $db->query($sql);
echo "<p>$sql;</p>";

$sql = 'create table campaigns_with_targets (campaign_id int(11), key `campaign_id` (`campaign_id`))';
// $db->query($sql);
echo "<p>$sql;</p>";
...
$sql = 'drop table if exists campaign_users_without_targets';
// $db->query($sql);
echo "<p>$sql;</p>";

$sql = 'create table campaign_users_without_targets (user_id int(11), campaign_id int(11), key `campaign_id` (`campaign_id`), key `user_id` (`user_id`))';
// $db->query($sql);
echo "<p>$sql;</p>";
...
$sql = 'ALTER TABLE tbl_campaign_nbm_targets_seq AUTO_INCREMENT = ' . $maxId;
echo "<p>$sql;</p>";
// $db->query($sql);
...
// create copy of tbl_meetings_shadow to use in batch queries.
...
function makeTemporaryTable($db)
{
	...
	$sql = 	'CREATE TABLE `tbl_data_statistics_temp` ( ' .
		'`id` int(11) NOT NULL auto_increment, ' .
		'`campaign_id` int(11) NOT NULL default \'0\', ' .
		'`user_id` int(11) NOT NULL default \'0\', ' .
...
function makeTemporaryTable_1($db)
{
	...
	$sql = 	'CREATE TABLE `tbl_data_statistics_temp_1` ( ' .
		'`id` int(11) NOT NULL auto_increment, ' .
		'`value` int(11), ' .
		'PRIMARY KEY  (`id`) ' .
		') ';
