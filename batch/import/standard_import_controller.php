...
require_once('CoverdaleRepairImport.class.php');
...
//new batch_emailTrapper_PostmarkEmailTrapper(file_get_contents('php://input'));
new batch_import_CoverdaleRepairImport('/Applications/MAMP/htdocs/alchemis-trunk/batch/import/coverdale_log.txt');
?>