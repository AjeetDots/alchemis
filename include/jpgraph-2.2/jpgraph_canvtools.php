...
class CanvasScale {
    ...
    private $ixmin=0,$ixmax=10,$iymin=0,$iymax=10;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'CanvasScale'), $args); }
...
class Shape {
    private $img,$scale;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'Shape'), $args); }
...
class CanvasRectangleText {
    ...
    private $iShadowWidth=3,$iShadowColor='';
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'CanvasRectangleText'), $args); }
