...
class PolarPlot {
    ...
    private $coord=null;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'PolarPlot'), $args); }
...
class PolarAxis extends Axis {
    ...
    private $radius_tick_color='black';
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'PolarAxis'), $args); }
...
class PolarScale extends LinearScale {
    private $graph;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'PolarScale'), $args); }
...
class PolarLogScale extends LogScale {
    private $graph;
        function __construct(...$args) { call_user_func_array(array($this, 'PolarLogScale'), $args); }
...
class PolarGraph extends Graph {
    ...
    public $iType=POLAR_360;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'PolarGraph'), $args); }
