...
class GanttActivityInfo {
    ...
    private $iHeaderAlign='center';
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'GanttActivityInfo'), $args); }
...
// CONSTRUCTOR	
    // Create a new gantt graph
        function __construct(...$args) { call_user_func_array(array($this, 'GanttGraph'), $args); }
...
//('Illegal icon index for Gantt builtin icon ['.$aIdx.']');
	...
	return Image::CreateFromString(base64_decode($this->iBuiltinIcon[$aIdx][1]));   
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'PredefIcons'), $args); }
...
class IconImage {
    ...
    private $iScale=1.0;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'IconImage'), $args); }
...
//---------------
// CONSTRUCTOR	
        function __construct(...$args) { call_user_func_array(array($this, 'TextProperty'), $args); }
...
//---------------
// CONSTRUCTOR	
        function __construct(...$args) { call_user_func_array(array($this, 'HeaderProperty'), $args); }
...
//---------------
// CONSTRUCTOR	
        function __construct(...$args) { call_user_func_array(array($this, 'GanttScale'), $args); }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'GanttConstraint'), $args); }
...
class GanttPlotObject {
    ...
    protected $iLabelLeftMargin=2;	// Title margin
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'GanttPlotObject'), $args); }
...
class HorizontalGridLine {
    ...
    private $iStart=0; // 0=from left margin, 1=just along header
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'HorizontalGridLine'), $args); }
...
//---------------
// CONSTRUCTOR	
        function __construct(...$args) { call_user_func_array(array($this, 'GanttBar'), $args); }
...
//---------------
// CONSTRUCTOR	
        function __construct(...$args) { call_user_func_array(array($this, 'MileStone'), $args); }
...
class TextPropertyBelow extends TextProperty {
        function __construct(...$args) { call_user_func_array(array($this, 'TextPropertyBelow'), $args); }
...
//---------------
// CONSTRUCTOR	
        function __construct(...$args) { call_user_func_array(array($this, 'GanttVLine'), $args); }
...
class LinkArrow {
    ...
    private $iColor='black';
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'LinkArrow'), $args); }
...
class GanttLink {
    ...
    private $iArrowSize=ARROW_S2,$iArrowType=ARROWT_SOLID;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'GanttLink'), $args); }
