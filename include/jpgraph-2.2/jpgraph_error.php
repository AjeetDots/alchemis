...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'ErrorPlot'), $args); }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'ErrorLinePlot'), $args); }
...
// CONSTRUCTOR
    // Data is (val, errdeltamin, errdeltamax)
        function __construct(...$args) { call_user_func_array(array($this, 'LineErrorPlot'), $args); }
