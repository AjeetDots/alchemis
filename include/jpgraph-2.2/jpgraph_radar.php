...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'RadarLogTicks'), $args); }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'RadarLinearTicks'), $args); }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'RadarAxis'), $args); }
...
//------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'RadarGrid'), $args); }
function RadarGrid() {
    }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'RadarPlot'), $args); }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'RadarGraph'), $args); }
