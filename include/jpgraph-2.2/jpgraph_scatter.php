...
class FieldArrow {
	...
	array(2,1),array(3,2),array(4,3),array(6,4),array(7,4),array(8,5),array(10,6),array(12,7),array(16,8),array(20,10));
        function __construct(...$args) { call_user_func_array(array($this, 'FieldArrow'), $args); }
function FieldArrow() {
    }
...
class FieldPlot extends Plot {
    private $iAngles;
    private $iCallback='';
        function __construct(...$args) { call_user_func_array(array($this, 'FieldPlot'), $args); }
...
//---------------
// CONSTRUCTOR
        function __construct(...$args) { call_user_func_array(array($this, 'ScatterPlot'), $args); }
