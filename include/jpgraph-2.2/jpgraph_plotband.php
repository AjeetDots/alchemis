...
class Rectangle {
    public $x,$y,$w,$h;
    public $xe, $ye;
        function __construct(...$args) { call_user_func_array(array($this, 'Rectangle'), $args); }
...
class RectPattern {
    ...
    protected $iBackgroundColor=-1;  // Default is no background fill
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPattern'), $args); }
...
class RectPatternSolid extends RectPattern {
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternSolid'), $args); }
...
class RectPatternHor extends RectPattern {
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternHor'), $args); }
...
class RectPatternVert extends RectPattern {
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternVert'), $args); }
...
class RectPatternRDiag extends RectPattern {
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternRDiag'), $args); }
...
class RectPatternLDiag extends RectPattern {
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternLDiag'), $args); }
...
class RectPattern3DPlane extends RectPattern {
    ...
    // converge.
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'RectPattern3DPlane'), $args); }
...
class RectPatternCross extends RectPattern {
    private $vert=null;
    private $hor=null;
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternCross'), $args); }
...
class RectPatternDiagCross extends RectPattern {
    private $left=null;
    private $right=null;
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternDiagCross'), $args); }
...
//=====================================================================
class RectPatternFactory {
        function __construct(...$args) { call_user_func_array(array($this, 'RectPatternFactory'), $args); }
...
class PlotBand {
    ...
    private $dir, $min, $max;
        ...
        function __construct(...$args) { call_user_func_array(array($this, 'PlotBand'), $args); }
