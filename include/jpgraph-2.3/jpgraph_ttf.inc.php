...
//---------------
// CONSTRUCTOR
    // Updated by ds: PHP 7+ deprecation - old constructor name as method. Use __construct() so AJAX JSON response is not corrupted by deprecation notice.
    // function TTF() {
...
// PUBLIC METHODS	
    ...
    // Updated by ds: renamed File() to getFontFilePath() to avoid same-name-as-class deprecation; callers updated in gd_image.inc.php.
    // function File($family,$style=FS_NORMAL) {
    function getFontFilePath($family,$style=FS_NORMAL) {
